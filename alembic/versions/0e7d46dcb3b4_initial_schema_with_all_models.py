...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_nutrients_created_by_user_id"),
        "nutrients",
        ["created_by_user_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_foods_created_by_user_id"),
        "foods",
        ["created_by_user_id"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["created_by_user_id"],
            ["users.id"],
            name=op.f("fk_meals_created_by_user_id_users"),
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_meals")),
    )
    op.create_index(
        op.f("ix_meals_created_by_user_id"),
        "meals",
        ["created_by_user_id"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["user_id"],
            ["users.id"],
            name=op.f("fk_user_goals_user_id_users"),
            ondelete="CASCADE",
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["food_id"],
            ["foods.id"],
            name=op.f("fk_food_logs_food_id_foods"),
            ondelete="RESTRICT",
        ),
        sa.ForeignKeyConstraint(
            ["meal_id"],
            ["meals.id"],
            name=op.f("fk_food_logs_meal_id_meals"),
            ondelete="SET NULL",
        ),
        sa.ForeignKeyConstraint(
            ["user_id"],
    ...
    op.create_index(
        op.f("ix_food_logs_food_id"), "food_logs", ["food_id"], unique=False
    )
    op.create_index(
        op.f("ix_food_logs_logged_at"), "food_logs", ["logged_at"], unique=False
    )
    op.create_index(
        op.f("ix_food_logs_meal_id"), "food_logs", ["meal_id"], unique=False
    )
    op.create_index(
    ...
    op.create_table(
        ...
        sa.Column(
            "amount_per_serving", sa.Numeric(precision=10, scale=2), nullable=False
        ),
        sa.Column(
            "created_at", sa.DateTime(), server_default=sa.text("now()"), nullable=False
        ),
    ...
    op.create_index(
        op.f("ix_food_nutrients_food_id"), "food_nutrients", ["food_id"], unique=False
    )
    op.create_index(
        "ix_food_nutrients_food_nutrient",
        "food_nutrients",
        ["food_id", "nutrient_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_food_nutrients_nutrient_id"),
        "food_nutrients",
        ["nutrient_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["food_id"],
            ["foods.id"],
            name=op.f("fk_recipe_ingredients_food_id_foods"),
            ondelete="RESTRICT",
        ),
        sa.ForeignKeyConstraint(
            ["recipe_id"],
        ...
        sa.PrimaryKeyConstraint(
            "recipe_ingredient_id", name=op.f("pk_recipe_ingredients")
        ),
    )
    op.create_index(
